    ...
    public partial class ConfirmBooking : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if(PreviousPage != null & PreviousPage.IsCrossPagePostBack)
            {
                ...
                lblDetails.Text = "Departure Date : " + DepartDate.Text + "</br>" + "From : "
                    + TravelFrom.SelectedItem.Value + "</br>" + "To : " + TravelTo.SelectedItem.Value +
                    "</br>" + AdultNo.Text + " Adult and " + ChildNo.Text + " Child. </br>" + "Ticket Price : " +
                    TicketPrice.Text;
            }
        }
    }
